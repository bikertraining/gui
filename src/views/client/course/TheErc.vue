            ...
            <div class="card-body">
                <ul class="list-unstyled mt-3 mb-4 text-start">
                    ...
                    <li><span class="fw-bold">Riders must provide a street-legal bike that passes a
                        ...
                        motorcycle is not owned by the rider, a notarized, written approval from the owner to use the
                        motorcycle in the course must be provided. Additionally, handlebars should not be over 15 inches
                        from the grips to the lowest part of the seat.
                    </li>
