            ...
            <div class="card-body">
                <ul class="list-unstyled mt-3 mb-4 text-start">
                    ...
                    <li class="mt-3">
                        <ol class="list-group-numbered list-group-flush d-grid gap-3">
                            ...
                            <li class="list-group-item">If you have entered all required enrollment information, near
                                                        the bottom of the page you will see a message in light green
                                                        that says, "Temporary
                            ...
                            <li class="list-group-item">To complete the registration, you must read and agree to the
                                                        Student Release(s) by checking the I Accept box. To activate
                                                        that checkbox, you must
                                                        first read the entire release by scrolling to the bottom of the
                                                        inset document. If you
                                                        cannot click on the 'I Accept' box, make sure you have scrolled
                                                        to the end of the waiver
                            ...
                            <li class="list-group-item">On your enrollment confirmation page, scroll down until you find
                                                        your username, your eight-character password, and the eCourse
                                                        login site
                                <NuxtLink target="_blank"
                                          to="https://elearning.msf-usa.org">https://elearning.msf-usa.org
                                </NuxtLink>
                                                        . Write down your login information or print this page. Click
                                                        the link to go to the MSF
                                                        eCourse Server Login page. If you closed your confirmation page
                                                        without writing down
                                                        your password, look for an email from noreply-res@msf-usa.org.
                    ...
                    <li class="mt-3 fw-bold">The course will not advance automatically. When the audio for a page ends,
                                             use the navigation bar at the bottom of the screen to move forward by
                                             clicking on the blinking
                                             red forward arrow.
                    </li>
                    ...
                    <li class="mt-3 fw-bold">Upon completion, you will be redirected to the course menu page (with the
                                             red “Click Here” button). Scroll down and click Completion Certificate.
                                             Email your completion
