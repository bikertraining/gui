            ...
            innerHTML: `
                {
                  ...
                  "itemListElement": [
                      ...
                      },
                      {
                        "@type": "ListItem",
                        "position": 3,
                        "name": "3-Wheel Basic Rider Course",
                        "item": "https://bikertraining.com/courses/3wbrc"
                      }
                  ]
                }
                    `,
            ...
            <div class="card-body">
                <ul class="list-unstyled mt-3 mb-4 text-start">
                    ...
                    <li class="mt-3">The range is a controlled, off-street, pedestrian-free environment. Students will
                                     learn and practice safely and correctly the various maneuvers and demanding
                                     situations
                                     encountered in street riding. Riders must pass both a written test and a riding
                                     skills test in
                                     order to complete the course. Upon successful completion, you will have met the
                                     State’s training
                                     requirement for obtaining a 3-wheel motorcycle endorsement at the driver's license
                                     office.
                    </li>
